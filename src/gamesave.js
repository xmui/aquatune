...
const TIER_KEYS = ['aq_mining_pick', 'aq_fishing_rod', 'aq_mining_stage', 'aq_fishing_zone', 'aq_rogue_depth', 'aq_mining_prestige', 'aq_mining_depth', 'aq_scratch_best', 'aq_lumber_axe', 'aq_lumber_zone', 'aq_fox_pet', 'aq_bs3d_best', 'aq_roulette_best_win'];
// Per-name counters (JSON {name:count}) — merge by max so neither side loses a catch.
const COUNT_KEYS = ['aq_fishing_caught', 'aq_owned_acc'];
// Free-form JSON/string blobs — newest writer wins (kept for completeness).
const BLOB_KEYS = ['aq_inventory', 'aq_tools', 'aq_fishing_log', 'aq_slots', 'aq_rogue_unlocks', 'aq_daily_challenge', 'aq_fish_pets', 'aq_msn_status', 'aq_msn_statusmsg', 'aq_msn_banner', 'aq_buddy_config'];
